...
class _PaymentsListingState extends State<PaymentsListing> {
  ...
  Widget paymentTable(List<String> userRoles) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("done_orders")
          .where("userRole", whereIn: userRoles)
          .snapshots(),
  ...
  Widget largeTitle(String title) {
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            largeTitle("Tailors & Fabric Cutters"),
            paymentTable(["tailor", "fabric_cutter"]),
            largeTitle("Shop Attendants"),
            paymentTable(["shop_attendant"])
          ],
        ),
      ),
    );
