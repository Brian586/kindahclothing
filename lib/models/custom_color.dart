class CustomColor {
  ...
  CustomColor({this.name, this.hex});

  factory CustomColor.fromJson(Map<String, dynamic> map) {
    return CustomColor(name: map["name"], hex: map["hex"]);
  }
}
...
List<Map<String, dynamic>> colorsMap = [
  ...
  {"name": "Loeen (Lopen) Look", "hex": "#15F2FD"},
